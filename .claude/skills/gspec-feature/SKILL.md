...
Your task is to take the provided feature description (which may be vague or detailed, small or large) and produce **one or more Product Requirements Documents (PRDs)** that clearly define _what_ is being built and _why_, without deep technical or architectural implementation details.
...
- Focus on _what_ users can do, not _how_ they do it
