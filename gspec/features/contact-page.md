...
- [x] **P0**: Page displays the business email address
...
- [x] **P0**: Page displays the business phone number
...
- [x] **P0**: Page displays the business physical address
...
- [x] **P1**: Contact details are scannable and visually organized
